...
const dialogues = Object.freeze({
  ...
  "smart-home-arrival": Object.freeze([
    Object.freeze({ speakerId: "aruna", text: "LAMPU DAN KIPAS RUMAH CERDAS TIDAK MERESPONS KONDISI RUANGAN. PERIKSA SENSOR DAN AKTUATORNYA." }),
  ]),
  "smart-home-complete": Object.freeze([
    Object.freeze({ speakerId: "aruna", text: "SMART HOME KEMBALI OTOMATIS. LANJUTKAN KE IoT LABORATORY." }),
  ]),
  "iot-laboratory-arrival": Object.freeze([
    Object.freeze({ speakerId: "aruna", text: "MIKROKONTROLER LAB TIDAK MENERIMA INPUT DENGAN BENAR. KITA PERLU MEMERIKSA PERAN PERANGKAT DAN I/O." }),
  ]),
  ...
  "smart-farm-arrival": Object.freeze([
    Object.freeze({ speakerId: "aruna", text: "TANAMAN KEKURANGAN AIR, TETAPI POMPA BELUM MENERIMA KEPUTUSAN YANG TEPAT. BACA DATA LINGKUNGANNYA." }),
  ]),
  "smart-farm-complete": Object.freeze([
    Object.freeze({ speakerId: "aruna", text: "KELEMBAPAN TANAH SUDAH TERCATAT DENGAN BENAR. SINYAL BERIKUTNYA BERASAL DARI SMART FACTORY." }),
  ]),
  "smart-factory-arrival": Object.freeze([
    Object.freeze({ speakerId: "aruna", text: "MONITORING MESIN MENUNJUKKAN GETARAN TIDAK WAJAR. KITA PERLU MEMBEDAKAN DETEKSI KONDISI DAN TINDAKAN MESIN." }),
  ]),
  ...
  "network-hub-arrival": Object.freeze([
    Object.freeze({ speakerId: "aruna", text: "DATA DARI SEMUA ZONA BELUM SAMPAI KE PUSAT. PERIKSA CARA PERANGKAT BERKOMUNIKASI DAN MENGIRIM PESAN." }),
  ]),
  "network-hub-complete": Object.freeze([
    Object.freeze({ speakerId: "aruna", text: "JALUR DATA TELAH PULIH. AKSES KE NEXUS CORE TERBUKA." }),
  ]),
  "nexus-core-final": Object.freeze([
    ...
    Object.freeze({ speakerId: "aruna", text: "LIMA ZONA STABIL. NEXUS CITY KEMBALI TERHUBUNG." }),
  ]),
});
